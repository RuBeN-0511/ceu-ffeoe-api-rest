...
public interface MondapiService {
	 ...
	 * Cifra la contraseña para compararla con la almacenada.
	 ...
	 * La contraseña nueva tendrá una longitud mínima de 8 caracteres.
	 * El usuario tiene que estar activo para poder cambiar la contraseña.
	 *
	 * @param id Identificador del usuario
	 * @param contraseñaAntigua Contraseña actual del usuario
	 * @param contraseñaNueva Nueva contraseña (mínimo 8 caracteres)
	 * @throws ValidationException si la contraseña nueva no cumple los requisitos
	...
	/**
	 * Consulta todos los usuarios relacionados con un alumno.
	 * Devuelve todos los datos del alumno con todas sus entidades asociadas
	 * (tutor, docentes y empresa).
	 *
	 * @param alumno El alumno del cual se quieren consultar los usuarios relacionados
	 * @return Lista de usuarios asociados al alumno (tutores, docentes, etc.)
	 * @throws NotFoundException si el alumno no existe
	 */
	public List<Usuario> consultarUsuarios(Alumno alumno);
 
	/**
	 * Genera un resumen completo de las prácticas de un alumno.
	 * Este resumen debe mostrar:
	 * i. Cantidad total de horas que hay que realizar
	 * ii. Cantidad total de horas realizadas (y tanto por ciento del total)
	 * iii. Cantidad total de horas pendientes
	 *
	 * @throws NotFoundException si no se encuentra la información del alumno
	 */
	public void resumenPracticas();
	 ...
	 */
	public Integer horasRealizadas();
 
	/**
	 * Consulta todos los registros de prácticas de un alumno.
	 * Devuelve una lista con todos los registros asociados al alumno.
	 *
	...
	/**
	 * Crea un nuevo registro de prácticas.
	...
	/**
	 * Elimina un registro de prácticas existente.
	 ...
	 */
	public void eliminarRegistros(String idRegistro);
